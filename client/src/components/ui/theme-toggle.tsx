...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="w-12 h-6 rounded-full bg-sakura-200 dark:bg-sakura-700 relative transition-colors duration-300 overflow-visible"
    >
      <div className="absolute w-full h-full inset-0 flex items-center justify-between px-1 pointer-events-none">
        <Sun className="h-3 w-3 text-sakura-600" />
        <Moon className="h-3 w-3 text-sakura-300" />
      </div>
